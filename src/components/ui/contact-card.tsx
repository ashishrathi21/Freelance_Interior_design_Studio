...
export function ContactCard({
	...
	return (
		<div
			className={cn(
				'bg-zinc-950 border border-zinc-600 relative grid h-full w-full shadow md:grid-cols-2 lg:grid-cols-3',
				className,
			)}
			{...props}
		>
			...
			<div
				className={cn(
					'bg-zinc-900 flex h-full w-full items-center border-t p-5 md:col-span-1 md:border-t-0 md:border-l',
					formSectionClassName,
				)}
			>
				{children}
